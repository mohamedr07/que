                        ...
                        <div className="card">
                            <div className="box">
                                <div className="content">
                                    ...
                                    <Link to="/processes"className="btn btn-card">View processes</Link>
                                </div>
                            </div>
                        </div>   
                    </div>
                        ...
                        <div className="card">
                            <div className="box">
                                <div className="content">
                                    ...
                                    <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                    <Link to="/providers"className="btn btn-card">View providers</Link>
                                </div>
                            </div>
                        </div>   
                    </div>
                        ...
                        <div className="card">
                            <div className="box">
                                <div className="content">
                                    ...
                                    <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                    <Link to="/stations"className="btn btn-card">View stations</Link>
                                </div>
                            </div>
                        </div>   
                    </div>
                        ...
                        <div className="card">
                            <div className="box">
                                <div className="content">
                                    ...
                                    <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                    <Link to="/queues"className="btn btn-card">View queues</Link>
                                </div>
                            </div>
                        </div>   
                    </div>

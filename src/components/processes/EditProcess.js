...
export default function EditProcess(props) {
    ...
    const editedProcessIndex  = useSelector(state => state.editReducer)
    ...
    //         const indexToremove = availableQueues.findIndex(queue => queue.id === q.id)
    //         availableQueues.splice(indexToremove, 1)
    //     })
    // })
                ...
                <div className="card card-signin my-5">
                    <div className="card-body">
                        <form className="form-signin">
                            ...
                            <Link to="/processes" onClick = {() => dispatch(editProcess(editedProcessIndex, processName, selectedQueues))} className="btn btn-primary btn-shape ">Submit</Link>
                        </form>
                    </div>
                </div>
            </div>
